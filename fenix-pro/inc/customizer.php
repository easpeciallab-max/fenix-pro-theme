...
function fenix_customize_register( $wp_customize ) {
	...
	$sections['fenix_links'] = array(
		...
		'fields'      => array(
			...
			'links_feature_img'     => array( 'รูปโชว์ (ใต้ปุ่ม LINE) · ไม่ใส่ = ซ่อน', 'image', 'แนะนำภาพแนวนอนออกแบบมาอย่างดี เช่น 1200×800px' ),
			'links_feature_url'     => array( 'รูปโชว์ · ลิงก์เมื่อคลิก (ไม่ใส่ = คลิกไม่ได้)', 'text' ),
