...
function fenix_defaults() {
	...
	$d = array(
		...
		'about_text'  => "FENIX PRO EA คือระบบช่วยเทรดอัตโนมัติ (Expert Advisor) บนแพลตฟอร์ม MetaTrader 5 ที่ทำงานตามเงื่อนไขที่กำหนดไว้ล่วงหน้า ช่วยให้การเข้า–ออกออเดอร์เป็นระบบมากขึ้น ลดการตัดสินใจจากอารมณ์ และติดตามการทำงานของระบบได้ง่ายผ่าน Dashboard\n\nEA ไม่ใช่เครื่องมือการันตีกำไร แต่เป็นผู้ช่วยให้คุณเทรดตามแผนได้สม่ำเสมอขึ้น ภายใต้การบริหารความเสี่ยงที่คุณเป็นผู้กำหนดเอง",
		...
		'feat1_desc'        => 'เข้า–ออกออเดอร์ตามเงื่อนไขที่กำหนดไว้ล่วงหน้า ไม่ใช่ตามอารมณ์',
